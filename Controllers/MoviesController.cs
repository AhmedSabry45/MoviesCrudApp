...
namespace DotNetCore5CRUD.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public MoviesController(MovieContext context, IToastNotification toastNotification)
        {
            _context = context;
        ...
        {
            //can access db list of movie here and send it to view
